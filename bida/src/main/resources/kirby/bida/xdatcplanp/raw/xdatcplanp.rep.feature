...
Feature: Tests for xdatcplanp in bida
  ...
  @execute
  Scenario: xdatcplanp-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/xdatcplanp/${version}/xdatcplanp.rep.conf
