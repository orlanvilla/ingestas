...
Feature: Tests for ydaspsecon in bida
  ...
  @execute
  Scenario: ydaspsecon-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bida/master/ydaspsecon/${version}/ydaspsecon.rep.conf
