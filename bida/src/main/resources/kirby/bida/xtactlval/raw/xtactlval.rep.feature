...
Feature: Tests for xtactlval in bida
  ...
  @execute
  Scenario: xtactlval-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/xtactlval/${version}/xtactlval.rep.conf
