@bida
Feature: Tests for xtactlval in bida

  @execute
  Scenario: xtactlval-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/master/xtactlval/${version}/xtactlval.rep.conf
