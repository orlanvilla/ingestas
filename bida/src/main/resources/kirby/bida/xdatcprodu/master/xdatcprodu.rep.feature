@bida
Feature: Tests for xdatcprodu in bida

  @execute
  Scenario: xdatcprodu-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/master/xdatcprodu/${version}/xdatcprodu.rep.conf
