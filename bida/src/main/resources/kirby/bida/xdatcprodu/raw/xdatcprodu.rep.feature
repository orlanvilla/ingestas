...
Feature: Tests for xdatcprodu in bida
  ...
  @execute
  Scenario: xdatcprodu-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/xdatcprodu/${version}/xdatcprodu.rep.conf
