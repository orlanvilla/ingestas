@bida
Feature: Tests for ydaicramos in bida

  @execute
  Scenario: ydaicramos-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/ydaicramos/${version}/ydaicramos.rep.conf
