...
Feature: Tests for ydaicramos in bida
  ...
  @execute
  Scenario: ydaicramos-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bida/master/ydaicramos/${version}/ydaicramos.rep.conf
