@bida
Feature: Tests for xtactvaleq in bida

  @execute
  Scenario: xtactvaleq-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/master/xtactvaleq/${version}/xtactvaleq.rep.conf
