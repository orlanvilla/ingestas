...
Feature: Tests for xtactvaleq in bida
  ...
  @execute
  Scenario: xtactvaleq-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/xtactvaleq/${version}/xtactvaleq.rep.conf
