@bida
Feature: Tests for ydaspmodal in bida

  @execute
  Scenario: ydaspmodal-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bida/raw/ydaspmodal/${version}/ydaspmodal.rep.conf
