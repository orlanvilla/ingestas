...
Feature: Tests for ydaspmodal in bida
  ...
  @execute
  Scenario: ydaspmodal-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bida/master/ydaspmodal/${version}/ydaspmodal.rep.conf
