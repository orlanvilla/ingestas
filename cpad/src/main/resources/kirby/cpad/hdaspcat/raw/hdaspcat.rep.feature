...
Feature: Tests for hdaspcat in cpad
  ...
  @execute
  Scenario: hdaspcat-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/cpad/raw/hdaspcat/${version}/hdaspcat.rep.conf
