@cpad
Feature: Tests for hdaspcat in cpad

  @execute
  Scenario: hdaspcat-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/cpad/master/hdaspcat/${version}/hdaspcat.rep.conf
