@cmol
Feature: Tests for ydaicmovpo in cmol

  @execute
  Scenario: ydaicmovpo-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cmol/raw/ydaicmovpo/${version}/ydaicmovpo.rep.conf
