@cisd
Feature: Tests for ydaicpoliz in cisd

  @execute
  Scenario: ydaicpoliz-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cisd/raw/ydaicpoliz/${version}/ydaicpoliz.rep.conf
