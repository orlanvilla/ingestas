@cisd
Feature: Tests for ydaicpcoas in cisd

  @execute
  Scenario: ydaicpcoas-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cisd/raw/ydaicpcoas/${version}/ydaicpcoas.rep.conf
