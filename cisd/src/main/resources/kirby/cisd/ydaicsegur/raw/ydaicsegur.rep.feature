@cisd
Feature: Tests for ydaicsegur in cisd

  @execute
  Scenario: ydaicsegur-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cisd/raw/ydaicsegur/${version}/ydaicsegur.rep.conf
