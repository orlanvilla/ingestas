...
Feature: Tests for ydaharel in bifi
  ...
  @execute
  Scenario: ydaharel-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydaharel/${version}/ydaharel.rep.conf
