@bifi
Feature: Tests for ydaharel in bifi

  @execute
  Scenario: ydaharel-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/ydaharel/${version}/ydaharel.rep.conf
