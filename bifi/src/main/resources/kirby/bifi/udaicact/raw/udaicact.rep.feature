...
Feature: Tests for udaicact in bifi
  ...
  @execute
  Scenario: udaicact-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/udaicact/${version}/udaicact.rep.conf
