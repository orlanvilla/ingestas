@bifi
Feature: Tests for udaicact in bifi

  @execute
  Scenario: udaicact-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/udaicact/${version}/udaicact.rep.conf
