@bifi
Feature: Tests for ydaspmovot in bifi

  @execute
  Scenario: ydaspmovot-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bifi/master/ydaspmovot/${version}/ydaspmovot.rep.conf
