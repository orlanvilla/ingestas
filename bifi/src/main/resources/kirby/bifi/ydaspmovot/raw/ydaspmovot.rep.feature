...
Feature: Tests for ydaspmovot in bifi
  ...
  @execute
  Scenario: ydaspmovot-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bifi/raw/ydaspmovot/${version}/ydaspmovot.rep.conf
