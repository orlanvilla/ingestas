@bifi
Feature: Tests for ydaicmovpo in bifi

  @execute
  Scenario: ydaicmovpo-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/ydaicmovpo/${version}/ydaicmovpo.rep.conf
