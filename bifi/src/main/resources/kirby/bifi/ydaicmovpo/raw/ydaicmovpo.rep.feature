...
Feature: Tests for ydaicmovpo in bifi
  ...
  @execute
  Scenario: ydaicmovpo-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydaicmovpo/${version}/ydaicmovpo.rep.conf
