...
Feature: Tests for ydaicrecib in bifi
  ...
  @execute
  Scenario: ydaicrecib-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydaicrecib/${version}/ydaicrecib.rep.conf
