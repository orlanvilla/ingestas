@bifi
Feature: Tests for ydaicrecib in bifi

  @execute
  Scenario: ydaicrecib-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/ydaicrecib/${version}/ydaicrecib.rep.conf
