@bifi
Feature: Tests for xdaicfac in bifi

  @execute
  Scenario: xdaicfac-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/xdaicfac/${version}/xdaicfac.rep.conf
