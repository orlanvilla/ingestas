...
Feature: Tests for xdaicfac in bifi
  ...
  @execute
  Scenario: xdaicfac-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/xdaicfac/${version}/xdaicfac.rep.conf
