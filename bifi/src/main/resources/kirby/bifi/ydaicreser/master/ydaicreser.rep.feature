@bifi
Feature: Tests for ydaicreser in bifi

  @execute
  Scenario: ydaicreser-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/ydaicreser/${version}/ydaicreser.rep.conf
