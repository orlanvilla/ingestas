...
Feature: Tests for ydaicreser in bifi
  ...
  @execute
  Scenario: ydaicreser-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydaicreser/${version}/ydaicreser.rep.conf
