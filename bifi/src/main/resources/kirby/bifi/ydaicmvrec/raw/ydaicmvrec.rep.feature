...
Feature: Tests for ydaicmvrec in bifi
  ...
  @execute
  Scenario: ydaicmvrec-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydaicmvrec/${version}/ydaicmvrec.rep.conf
