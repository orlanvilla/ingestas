...
Feature: Tests for ydahaplc in bifi
  ...
  @execute
  Scenario: ydahaplc-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydahaplc/${version}/ydahaplc.rep.conf
