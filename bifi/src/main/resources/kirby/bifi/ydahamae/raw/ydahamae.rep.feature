...
Feature: Tests for ydahamae in bifi
  ...
  @execute
  Scenario: ydahamae-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/ydahamae/${version}/ydahamae.rep.conf
