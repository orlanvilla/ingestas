@bifi
Feature: Tests for xdaicmoram in bifi

  @execute
  Scenario: xdaicmoram-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/master/xdaicmoram/${version}/xdaicmoram.rep.conf
