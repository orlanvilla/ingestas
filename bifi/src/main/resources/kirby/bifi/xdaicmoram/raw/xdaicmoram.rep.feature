...
Feature: Tests for xdaicmoram in bifi
  ...
  @execute
  Scenario: xdaicmoram-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bifi/raw/xdaicmoram/${version}/xdaicmoram.rep.conf
