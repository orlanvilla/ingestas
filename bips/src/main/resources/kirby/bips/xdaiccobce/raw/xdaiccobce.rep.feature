...
Feature: Tests for xdaiccobce in bips
  ...
  @execute
  Scenario: xdaiccobce-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaiccobce/${version}/xdaiccobce.rep.conf
