@bips
Feature: Tests for xdaiccobce in bips

  @execute
  Scenario: xdaiccobce-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaiccobce/${version}/xdaiccobce.rep.conf
