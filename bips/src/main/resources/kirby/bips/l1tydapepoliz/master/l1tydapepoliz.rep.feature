@bips
Feature: Tests for l1tydapepoliz in bips

  @execute
  Scenario: l1tydapepoliz-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/l1tydapepoliz/${version}/l1tydapepoliz.rep.conf
