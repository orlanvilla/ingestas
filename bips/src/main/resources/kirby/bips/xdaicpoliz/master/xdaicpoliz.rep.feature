@bips
Feature: Tests for xdaicpoliz in bips

  @execute
  Scenario: xdaicpoliz-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaicpoliz/${version}/xdaicpoliz.rep.conf
