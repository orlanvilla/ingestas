...
Feature: Tests for xdaicpoliz in bips
  ...
  @execute
  Scenario: xdaicpoliz-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaicpoliz/${version}/xdaicpoliz.rep.conf
