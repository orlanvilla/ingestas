...
Feature: Tests for ydaicpred in bips
  ...
  @execute
  Scenario: ydaicpred-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/ydaicpred/${version}/ydaicpred.rep.conf
