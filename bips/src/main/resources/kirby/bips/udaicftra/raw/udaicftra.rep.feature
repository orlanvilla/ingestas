...
Feature: Tests for udaicftra in bips
  ...
  @execute
  Scenario: udaicftra-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/udaicftra/${version}/udaicftra.rep.conf
