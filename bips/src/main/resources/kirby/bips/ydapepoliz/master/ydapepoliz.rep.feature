...
Feature: Tests for ydapepoliz in bips
  ...
  @execute
  Scenario: ydapepoliz-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bips/master/ydapepoliz/${version}/ydapepoliz.rep.conf
