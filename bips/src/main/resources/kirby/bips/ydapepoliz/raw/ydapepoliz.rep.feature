@bips
Feature: Tests for ydapepoliz in bips

  @execute
  Scenario: ydapepoliz-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/ydapepoliz/${version}/ydapepoliz.rep.conf
