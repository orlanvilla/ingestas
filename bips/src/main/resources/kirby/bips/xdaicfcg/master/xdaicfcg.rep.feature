@bips
Feature: Tests for xdaicfcg in bips

  @execute
  Scenario: xdaicfcg-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaicfcg/${version}/xdaicfcg.rep.conf
