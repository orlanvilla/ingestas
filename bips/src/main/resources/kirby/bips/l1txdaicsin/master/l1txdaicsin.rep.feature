@bips
Feature: Tests for l1txdaicsin in bips

  @execute
  Scenario: l1txdaicsin-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/l1txdaicsin/${version}/l1txdaicsin.rep.conf
