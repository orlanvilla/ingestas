...
Feature: Tests for xdaicbie in bips
  ...
  @execute
  Scenario: xdaicbie-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaicbie/${version}/xdaicbie.rep.conf
