...
Feature: Tests for xdaicsin in bips
  ...
  @execute
  Scenario: xdaicsin-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaicsin/${version}/xdaicsin.rep.conf
