@bips
Feature: Tests for xdaicsin in bips

  @execute
  Scenario: xdaicsin-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaicsin/${version}/xdaicsin.rep.conf
