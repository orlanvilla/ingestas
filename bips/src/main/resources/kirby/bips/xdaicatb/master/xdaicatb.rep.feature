...
Feature: Tests for xdaicatb in bips
  ...
  @execute
  Scenario: xdaicatb-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaicatb/${version}/xdaicatb.rep.conf
