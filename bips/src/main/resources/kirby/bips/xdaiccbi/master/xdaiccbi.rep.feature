@bips
Feature: Tests for xdaiccbi in bips

  @execute
  Scenario: xdaiccbi-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaiccbi/${version}/xdaiccbi.rep.conf
