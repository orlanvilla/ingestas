...
Feature: Tests for xdaiccbi in bips
  ...
  @execute
  Scenario: xdaiccbi-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaiccbi/${version}/xdaiccbi.rep.conf
