...
Feature: Tests for xdaiccpo in bips
  ...
  @execute
  Scenario: xdaiccpo-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bips/master/xdaiccpo/${version}/xdaiccpo.rep.conf
