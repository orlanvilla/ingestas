...
Feature: Tests for xdaidapr in bips
  ...
  @execute
  Scenario: xdaidapr-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaidapr/${version}/xdaidapr.rep.conf
