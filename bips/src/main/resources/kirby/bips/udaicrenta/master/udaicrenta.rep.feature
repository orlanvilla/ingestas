@bips
Feature: Tests for udaicrenta in bips

  @execute
  Scenario: udaicrenta-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/udaicrenta/${version}/udaicrenta.rep.conf
