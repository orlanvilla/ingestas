...
Feature: Tests for xdaiccapol in bips
  ...
  @execute
  Scenario: xdaiccapol-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bips/raw/xdaiccapol/${version}/xdaiccapol.rep.conf
