@bips
Feature: Tests for udaicgseg in bips

  @execute
  Scenario: udaicgseg-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/udaicgseg/${version}/udaicgseg.rep.conf
