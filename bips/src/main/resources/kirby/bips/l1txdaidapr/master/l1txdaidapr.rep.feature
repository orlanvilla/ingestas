@bips
Feature: Tests for l1txdaidapr in bips

  @execute
  Scenario: l1txdaidapr-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/l1txdaidapr/${version}/l1txdaidapr.rep.conf
