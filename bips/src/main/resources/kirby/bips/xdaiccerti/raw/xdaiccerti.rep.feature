...
Feature: Tests for xdaiccerti in bips
  ...
  @execute
  Scenario: xdaiccerti-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/xdaiccerti/${version}/xdaiccerti.rep.conf
