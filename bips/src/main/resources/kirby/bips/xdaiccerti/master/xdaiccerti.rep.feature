@bips
Feature: Tests for xdaiccerti in bips

  @execute
  Scenario: xdaiccerti-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaiccerti/${version}/xdaiccerti.rep.conf
