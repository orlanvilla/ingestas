...
Feature: Tests for ydaicsegur in bips
  ...
  @execute
  Scenario: ydaicsegur-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bips/master/ydaicsegur/${version}/ydaicsegur.rep.conf
