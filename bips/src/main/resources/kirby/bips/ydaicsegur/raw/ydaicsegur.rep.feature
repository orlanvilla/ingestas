@bips
Feature: Tests for ydaicsegur in bips

  @execute
  Scenario: ydaicsegur-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/ydaicsegur/${version}/ydaicsegur.rep.conf
