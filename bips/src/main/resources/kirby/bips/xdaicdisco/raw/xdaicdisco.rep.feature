...
Feature: Tests for xdaicdisco in bips
  ...
  @execute
  Scenario: xdaicdisco-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bips/raw/xdaicdisco/${version}/xdaicdisco.rep.conf
