@bips
Feature: Tests for xdaicdisco in bips

  @execute
  Scenario: xdaicdisco-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/xdaicdisco/${version}/xdaicdisco.rep.conf
