...
Feature: Tests for ydaicpoliz in bips
  ...
  @execute
  Scenario: ydaicpoliz-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/raw/ydaicpoliz/${version}/ydaicpoliz.rep.conf
