@bips
Feature: Tests for ydaicpoliz in bips

  @execute
  Scenario: ydaicpoliz-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bips/master/ydaicpoliz/${version}/ydaicpoliz.rep.conf
