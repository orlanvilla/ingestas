...
Feature: Tests for udaictrglo in biac
  ...
  @execute
  Scenario: udaictrglo-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biac/raw/udaictrglo/${version}/udaictrglo.rep.conf
