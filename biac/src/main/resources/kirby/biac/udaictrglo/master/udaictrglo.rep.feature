@biac
Feature: Tests for udaictrglo in biac

  @execute
  Scenario: udaictrglo-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biac/master/udaictrglo/${version}/udaictrglo.rep.conf
