...
Feature: Tests for balanceaccount in kmcs
  ...
  @execute
  Scenario: balanceaccount-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/kmcs/raw/balanceaccount/${version}/balanceaccount.rep.conf
