@kmcs
Feature: Tests for balanceaccount in kmcs

  @execute
  Scenario: balanceaccount-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/kmcs/master/balanceaccount/${version}/balanceaccount.rep.conf
