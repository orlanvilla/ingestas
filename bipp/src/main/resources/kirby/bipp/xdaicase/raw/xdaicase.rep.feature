...
Feature: Tests for xdaicase in bipp
  ...
  @execute
  Scenario: xdaicase-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/raw/xdaicase/${version}/xdaicase.rep.conf
