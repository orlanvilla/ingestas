@bipp
Feature: Tests for xdaicase in bipp

  @execute
  Scenario: xdaicase-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/master/xdaicase/${version}/xdaicase.rep.conf
