@bipp
Feature: Tests for l1txdapeterce in bipp

  @execute
  Scenario: l1txdapeterce-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/master/l1txdapeterce/${version}/l1txdapeterce.rep.conf
