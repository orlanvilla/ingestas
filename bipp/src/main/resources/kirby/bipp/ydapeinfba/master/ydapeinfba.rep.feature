@bipp
Feature: Tests for ydapeinfba in bipp

  @execute
  Scenario: ydapeinfba-master-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/bipp/master/ydapeinfba/${version}/ydapeinfba.rep.conf
