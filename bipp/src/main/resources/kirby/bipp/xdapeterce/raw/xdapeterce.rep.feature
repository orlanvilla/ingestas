...
Feature: Tests for xdapeterce in bipp
  ...
  @execute
  Scenario: xdapeterce-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/raw/xdapeterce/${version}/xdapeterce.rep.conf
