@bipp
Feature: Tests for xdaiccoase in bipp

  @execute
  Scenario: xdaiccoase-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/master/xdaiccoase/${version}/xdaiccoase.rep.conf
