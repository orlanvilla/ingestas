...
Feature: Tests for xdaiccoase in bipp
  ...
  @execute
  Scenario: xdaiccoase-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/raw/xdaiccoase/${version}/xdaiccoase.rep.conf
