@bipp
Feature: Tests for xdapeclien in bipp

  @execute
  Scenario: xdapeclien-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/master/xdapeclien/${version}/xdapeclien.rep.conf
