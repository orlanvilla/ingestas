...
Feature: Tests for xdapeclien in bipp
  ...
  @execute
  Scenario: xdapeclien-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/bipp/raw/xdapeclien/${version}/xdapeclien.rep.conf
