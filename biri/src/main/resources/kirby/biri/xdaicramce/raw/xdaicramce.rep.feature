...
Feature: Tests for xdaicramce in biri
  ...
  @execute
  Scenario: xdaicramce-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/raw/xdaicramce/${version}/xdaicramce.rep.conf
