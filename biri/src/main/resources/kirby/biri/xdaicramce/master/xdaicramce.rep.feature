@biri
Feature: Tests for xdaicramce in biri

  @execute
  Scenario: xdaicramce-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/master/xdaicramce/${version}/xdaicramce.rep.conf
