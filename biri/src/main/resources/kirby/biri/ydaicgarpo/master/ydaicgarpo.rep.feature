@biri
Feature: Tests for ydaicgarpo in biri

  @execute
  Scenario: ydaicgarpo-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/master/ydaicgarpo/${version}/ydaicgarpo.rep.conf
