...
Feature: Tests for ydaicgarse in biri
  ...
  @execute
  Scenario: ydaicgarse-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/raw/ydaicgarse/${version}/ydaicgarse.rep.conf
