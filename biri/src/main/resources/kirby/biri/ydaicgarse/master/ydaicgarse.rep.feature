@biri
Feature: Tests for ydaicgarse in biri

  @execute
  Scenario: ydaicgarse-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/master/ydaicgarse/${version}/ydaicgarse.rep.conf
