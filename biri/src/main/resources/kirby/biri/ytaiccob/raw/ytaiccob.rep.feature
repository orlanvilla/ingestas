...
Feature: Tests for ytaiccob in biri
  ...
  @execute
  Scenario: ytaiccob-raw-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/raw/ytaiccob/${version}/ytaiccob.rep.conf
