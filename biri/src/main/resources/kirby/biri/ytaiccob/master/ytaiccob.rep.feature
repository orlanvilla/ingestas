@biri
Feature: Tests for ytaiccob in biri

  @execute
  Scenario: ytaiccob-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/biri/master/ytaiccob/${version}/ytaiccob.rep.conf
