@kipp
Feature: Tests for mgkippinsurcustl1t in kipp

  @execute
  Scenario: mgkippinsurcustl1t-master-rep
    Given an ingestion config file ${repository.endpoint.vdc}/${repository.repo.schemas}/kirby/co/kipp/master/mgkippinsurcustl1t/${version}/mgkippinsurcustl1t.rep.conf
