@cgug
Feature: Tests for ydaicgarpo in cgug

  @execute
  Scenario: ydaicgarpo-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cgug/raw/ydaicgarpo/${version}/ydaicgarpo.rep.conf
