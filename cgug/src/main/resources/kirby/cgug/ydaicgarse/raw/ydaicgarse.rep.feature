@cgug
Feature: Tests for ydaicgarse in cgug

  @execute
  Scenario: ydaicgarse-raw-rep
    Given an ingestion config file ${repository.endpoint}/${repository.repo}/kirby/co/cgug/raw/ydaicgarse/${version}/ydaicgarse.rep.conf
